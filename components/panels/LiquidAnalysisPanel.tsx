...
// Sample InSAR image descriptions — global assets
// riskScore/rateMMmo/etc are passed to the analysis engine for context-aware output
const SAR_SAMPLES = [
  {
    id: "mexico_city_insar",
    label: "Mexico City Historic Centre — InSAR",
    assetName: "Mexico City Historic Centre",
    assetType: "building",
    location: "Centro Histórico, Mexico City, Mexico",
    description: "Lacustrine clay compaction subsidence bowl",
    riskScore: 96,
    riskLevel: "dangerous",
    rateMMmo: -11.8,
    totalMM: -124.6,
  ...
  {
    id: "jakarta_subsidence_insar",
    label: "Jakarta CBD Subsidence — InSAR",
    assetName: "Jakarta CBD Subsidence Zone",
    assetType: "building",
    location: "Central Business District, Jakarta, Indonesia",
    description: "Groundwater extraction bowl — widest subsidence zone in SE Asia",
    riskScore: 94,
    riskLevel: "dangerous",
    rateMMmo: -21.3,
    totalMM: -193.2,
  ...
  {
    id: "chamoli_slope_insar",
    label: "Chamoli Avalanche Scar — InSAR",
    assetName: "Chamoli Rock-Ice Avalanche Scar",
    assetType: "slope",
    location: "Chamoli District, Uttarakhand, India",
    description: "Post-event slope displacement field — translational failure kinematics",
    riskScore: 91,
    riskLevel: "dangerous",
    rateMMmo: -18.7,
    totalMM: -178.4,
...
const CAMERA_FEEDS = [
  {
    id: "bosphorus_deck_cam",
    label: "Deck Cam — Bosphorus Bridge FSM",
    description: "Structural joint monitoring, mid-span",
    aiPrompt: "suspension bridge deck structural monitoring camera showing expansion joint and cable anchorage zone",
  },
  {
    id: "jakarta_foundation_cam",
    label: "Foundation Cam — Jakarta CBD",
    description: "Pile cap settlement sensor array",
    aiPrompt: "urban subsidence monitoring camera showing building foundation level markers and settlement gauges",
  },
];
